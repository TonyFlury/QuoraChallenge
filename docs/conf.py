# -*- coding: utf-8 -*-
#
# Quora Challenge documentation build configuration file, created by
...
htmlhelp_basename = 'quorachallengedoc'
...
latex_documents = [
  (master_doc, 'quorachallenge.tex', u'Quora Challenge Documentation',
   [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'quorachallenge', u'Quora Challenge Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'quorachallenge', u'Quora Challenge Documentation',
   author, 'quorachallenge', 'Quora Challenge Framework.',
   'Miscellaneous'),
]
